...
routes_dict = {
	'roada': {'aaaa::212:4b00:60d:b318': '0', 'aaaa::212:4b00:60d:b288': '0'}, 
	'roadb': {'aaaa::212:4b00:60d:b41c': '2', 'aaaa::212:4b00:60d:b374': '2'}, 
	'feu3':  {                                                              }, 
	'sensorRoad1': {                                                        }, 
	'sensorRoad2': {                                                        }
} #Just for testing, automatically add new addresses and topics
...
def start_client():
	...
	if ENABLE_MQTT:
		...
		client.username_pw_set("A1E-3CmXYHPv2beMPO5TiSDJ52Un1Nxz87", "aghiles") #A1E-dEzBw6HHcOgRUz22KIwvuYkfvmfixy, A1E-rnSeKf6ZnttxdT4d2aXmpU45Eyrzst
