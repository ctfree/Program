...
var mqttServer = 'mqtt://' + process.argv[2];
var mqttPort = process.argv[3];
var apiPort = process.argv[4];
var dbServer = process.argv[5];
var account = process.argv[6];
var passwd = process.argv[7];
var opt = { port:mqttPort, clientId:"server" };
...
app.get("*", function(req, res){
	res.send('This is general route');
});
app.listen(apiPort, function(req, res){
	console.log("server start in " + apiPort + " port");
});
