...
As test laboratory setup we used three participating nodes: node 1 as source, node 2 as relay node and node 3 as sink. node 1 sends the RTS at -11dBm, the ATS is sent at -11dBm when relaying was decided, and it is at 14dBm when direct communication was decided.