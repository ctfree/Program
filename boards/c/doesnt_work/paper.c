...
retry:
        ...
        // Output power to the 12.5 dBm direct wub
      ...
      //  cc112x_set_output_power(0x2C);//4.5dbm (thepricalformula)
       ...
       //  cc112x_set_output_power(0x10);//-6dbm (experimentallformula)   //-9.5 theorical formula

         //cc112x_set_output_power(0xC);//-7dbm (experimentallformula)   //-11.5 theorical formula

         // cc112x_set_output_power(0x34);//10dbm (experiemntal formula) //8.5 theorical formula
        ...
        // t_duration=t_duration * 0.5e-6f;
         ...
         if (t_duration >t_seuil){
             ...
             //send data
                    ...
                    cc112x_set_output_power(0x34); //8.5 dbm
