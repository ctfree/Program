...
unsigned short receive_adress ()
{
    ...
    for (int rec_i=1; rec_i<16; rec_i++){
...
retry:
       ...
       // Enabling WuRx IT
        ...
        //check if it is the right interruption (ATS)

         adress_received=receive_adress ();

         if (adress_received!=ATS_ADDRESS)
             goto debut;
