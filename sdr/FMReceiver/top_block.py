...
# Title: Top Block
# Generated: Sun Nov 26 23:17:28 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._gain_range = Range(10, 90, 1, 80, 200)
        self._gain_win = RangeWidget(self._gain_range, self.set_gain, "gain", "counter_slider", float)
        self.tab_layout_1.addWidget(self._gain_win)
        self._freq_range = Range(90e6, 150e6, 0.5e6, 107.8e6, 200)
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, "freq", "counter_slider", float)
        self.tab_layout_1.addWidget(self._freq_win)
        self._amp_range = Range(0, 1, 0.1, 0.7, 200)
        self._amp_win = RangeWidget(self._amp_range, self.set_amp, "amp", "counter_slider", float)
        self.tab_layout_1.addWidget(self._amp_win)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/media/raf/DDR/Enseignement/2017-2018/ESIEE/Labs/Renaud - Mistral gagnant (Clip officiel).wav', True)
